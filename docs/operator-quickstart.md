# Operator Quickstart — Mining Services Contractor Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0990** (`cloud-itonami-isic-0990`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0990.git
cd cloud-itonami-isic-0990
```
...
- Blueprint governor key: `mining-services-governor`
- Likely source path: `mining_services.governor.cljc`
